...
class OmarVideoPluginGrailsPlugin extends Plugin {
   ...
   // URL to the plugin's documentation
       def documentation = "https://grails.github.io/OmarVideoPlugin/"
   ...
   //    def issueManagement = [ system: "GitHub", url: "https://github.com/grails/OmarVideoPlugin/issues" ]

       // Online location of the plugin's browseable source code.
   //    def scm = [ url: "https://github.com/grails/OmarVideoPlugin" ]
